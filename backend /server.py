...
gemini_api_key = "AIzaSyDsMsRfDkVXx4SJCxxyQ_yuSviMkG7HvU4"
...
news_df = agent.process_news(num_links=4) # news_df -> top15 news of that topic
...
for i in unique_news_indices:
    ...
    print(topic)
    news = agent.process_news(num_links=3)
